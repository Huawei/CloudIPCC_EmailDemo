...
public class WorkThread extends Thread implements WorkThreadMBean
{
    ...
    public WorkThread(String name)
    {
        ...
        try
		{
    		try
            {
                ObjectName oname = new ObjectName("com.huawei.adapter:name=" + this.getName());
        ...
        {
            LOGGER.error("The work thread register MBean fail. name=" + this.getName() 
                    + ", CommonException = " + LogUtils.encodeForLog(ex.getMessage()));
        }
    }
    ...
    void shutdown()
    {
        ...
        try
		{
            ...
            {
                LOGGER.error("The work thread unregister MBean fail. name=" + this.getName() + ", exception = " + LogUtils.encodeForLog(e.getMessage()));
            }
    		catch (Exception e)
            {
                throw new CommonException(e);
        ...
        {
            LOGGER.error("The work thread unregister MBean fail. name=" + this.getName() + ", CommonException = " + LogUtils.encodeForLog(ex.getMessage()));
        }
    }
    ...
    public void run()
    {
        while (this.run)
        {
			...
			{
			    LOGGER.error("run task exception, CommonException = " + LogUtils.encodeForLog(ex.getMessage()));
			}
        }
    }
